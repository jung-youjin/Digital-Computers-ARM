...
SOMEDELAY             EQU 200000    ; faster than 500ms delay at ~16 MHz clock - inaccurate - adjust it to get it right
...
loop1
    SUBS R0, R0, #1               ; write data to Port F to turn lights on and off
...
; Note: a dedicated register to hold GPIO_PORTF_DATA_R can be used to save re-loading it to do the write
	...
	; this is already loaded into R1 above LDR R1, =GPIO_PORTF_DATA_R
