...
;	BL SIMPLECOUNTER 			; //Deliverable 1

	BL DelayReaction			;The rand 'timer'	

	MOV R3, #RED 				;Turn LED ON (After rand time)
	LDR R2, =GPIO_PORTF_DATA_R  
	STR R3, [R2]	
	
	BL SWITCH 					;Poll and 'count' reaction time/ time till user pushes button
	
STARTBLINK						;Return from SWITCH 
	
	
	MOV R7, R4					;Move reaction time 'count' to R7 which LEDBLINK displays
	MOV R2, #4					;Four count to display the 4 set of 8 bits in the 32 bit reaction time count
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Input: None
;Output: will display R7 to the 8 LEDs
...
;Input: rand num in R11
;Output: None, but will delay program for rand time between 2-10 sec
...
;MAIN DELAY SUBPROGRAM
;Input: R0 for num times to repeat delay
;Output: None
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;SIMPLE COUNTER DELIVERABLE ONE

;Input: None
;Outputs: a Count from 1-255 on the 8 LEDs
...
;POST LAB
; Question 1
; 8 bits --> 0.0255 s (2^8-1)*0.1ms
; 16 bits --> 6.5535 s (2^16-1)*0.1ms
; 24 bits --> 1677.7215 s (2^24-1)*0.1ms
; 32 bits --> 429496.7295 s (2^32-1)*0.1ms


; Question 2
; Average reaction time for humans is 0.25 seconds to a visual stimulus.
; Therefore, 16 bits can be the best choice for this task.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
